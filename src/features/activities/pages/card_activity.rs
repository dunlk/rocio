    ...
    view! {
            ...
            ">
                ...
                <div class="flex items-center justify-between">
                    ...
                    // Actividad
                    <div class="min-w-0">
                        <p class="text-lg font-bold truncate">"Mensualidad Agosto"</p>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-xl font-bold text-cyan-300">"S/ 50.00"</p>
                    </div>
                ...
                ">
                    <div>
                        ...
                        <p class="font-medium">"01/08/2026"</p>
                    </div>

                    <div class="text-right">
                        <p class="text-xs text-white/40">"Vencimiento"</p>
                        <p class="font-medium text-pink-300">"10/08/2026"</p>
                    </div>
                </div>
            </div>
    }
